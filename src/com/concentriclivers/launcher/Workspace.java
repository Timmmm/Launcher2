...
import com.concentriclivers.launcher.FolderIcon.FolderRingAnimator;
import com.concentriclivers.launcher.LauncherSettings.Favorites;
    ...
    private void updateChildrenLayersEnabled() {
        ...
        if (enableChildrenLayers != mChildrenLayersEnabled) {
            ...
            for (int i = 0; i < getPageCount(); i++) {
            	// TDH: Can't call this. Use the reflection method I added below.
//                ((ViewGroup)getChildAt(i)).setChildrenLayersEnabled(mChildrenLayersEnabled);
            	setChildrenLayersEnabled((ViewGroup)getChildAt(i), mChildrenLayersEnabled);
            }
        }
    }
    
    // TDH: Added this function for the above updateChildrenLayersEnabled() method.
    ...
    */
    ...
    static Rect getCellLayoutMetrics(Launcher launcher, int orientation) {
        ...
        // TDH: Not available yet. Code below replaces it.
//        display.getCurrentSizeRange(smallestSize, largestSize);
        
        DisplayMetrics displayMetrics = new DisplayMetrics();
        display.getMetrics(displayMetrics);
        // I think this is right, since there is usually nothing on the sides of the display.
        int w = Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels);
        int h = Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels);
        smallestSize.x = w;
        largestSize.x = h;
        int statusBarHeight = MEDIUM_DPI_STATUS_BAR_HEIGHT;
        ...
        smallestSize.y = h - statusBarHeight;
        largestSize.y = w - statusBarHeight;
