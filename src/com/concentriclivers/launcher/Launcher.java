...
// TDH: Can't use this, although we can use SystemPropertiesProxy if necessary.
...
import com.concentriclivers.launcher.DropTarget.DragObject;
...
public final class Launcher extends Activity
    ...
    protected void onActivityResult(
        ...
        if (requestCode == REQUEST_BIND_APPWIDGET) {
        	// TDH: Add this otherwise long presses don't work after dropping a widget!
...
//        ValueAnimator.clearAllAnimations();
    ...
    public void startSearch(String initialQuery, boolean selectInitialQuery,
        ...
        if (appSearchData == null) {
            ...
            // TDH: Search.SOURCE->Search_SOURCE.
    ...
    void addAppWidgetImpl(final int appWidgetId, ItemInfo info, AppWidgetHostView boundWidget,
        ...
        if (appWidgetInfo.configure != null) {
        	...
        	// TDH: For the standard route, info should not be null.
        	if (info != null)
        	{
        		// TDH: JB code.
			...
			{
				completeAddAppWidget(appWidgetId, mPendingAddInfo.container, mPendingAddInfo.screen,
						boundWidget, appWidgetInfo);
				// TDH: Since we didn't do it in onActivityResult.
				resetAddInfo();
			}
	...
	void addAppWidgetFromDrop(PendingAddWidgetInfo info, long container, int screen,
        ...
        if (hostView != null) {
        	...
        	{
        		Log.d(TAG, "Starting pick activity.");
        		mPendingAddWidgetInfo = info.info;
    			// TDH: User must pick the same widget again.
    			Intent pickIntent = new Intent(AppWidgetManager.ACTION_APPWIDGET_PICK);
    			pickIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);
    			startActivityForResult(pickIntent, REQUEST_BIND_APPWIDGET);
        	}
        }
    }
...
//                    }
    ...
    boolean startActivity(View v, Intent intent, Object tag) {
        ...
        try {
            ...
            // TDH: Can't use ActivityOptions yet.
...
//                        observer.removeOnGlobalLayoutListener(this);
    ...
    // TDH: This is used in several places.
	private ComponentName getGlobalSearchActivity()
	{
		final SearchManager searchManager =
                (SearchManager) getSystemService(Context.SEARCH_SERVICE);
		
		// TDH: Workaround for the below being private.
		ComponentName activityName;
		try
		{
			Method getGlobalSearchActivity = SearchManager.class.getDeclaredMethod("getGlobalSearchActivity");
			getGlobalSearchActivity.setAccessible(true);

			activityName = (ComponentName) getGlobalSearchActivity.invoke(searchManager);
		}
		catch (Exception e)
		{
			e.printStackTrace();
...
//        ComponentName globalSearchActivity = searchManager.getGlobalSearchActivity();
    ...
    public boolean isRotationEnabled() {
    	// TDH: We won't force enable rotation by default.
    	// TDH: TODO: Use SystemPropertiesProxy.
...
//                FORCE_ENABLE_ROTATION_PROPERTY, "false"));
    ...
    private Cling initCling(int clingId, int[] positionData, boolean animate, int delay) {
        ...
        if (cling != null) {
            ...
            // TDH: Again, sorry disabled people; this is not available.
